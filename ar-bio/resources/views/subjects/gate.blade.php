...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			<div id="learned-logo">
			<a href="../index.blade.php"><img src="../images/icon/logo.png" style="width: 120px;"></a></div>
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../images/icon/menu.png"></div>
			<ul id="list-switch">
				<li><a href="jee.blade.php"><img src="../images/courses/d1.png" class="icon">JEE</a></li>
				<li><a href="#"><img src="../images/courses/paper.png" class="icon">GATE</a></li>
				<li><a href="computer_courses.blade.php"><img src="../images/courses/computer.png" class="icon">Computer Courses</a></li>
				<li><a href="computer_courses.blade.php#data"><img src="../images/courses/data.png" class="icon">Data Structures</a></li>
				<li><a href="computer_courses.blade.php#algo"><img src="../images/courses/algo.png" class="icon">Algorithm</a></li>
				<li><a href="computer_courses.blade.php#projects"><img src="../images/courses/projects.png" class="icon">Projects</a></li>
			</ul>
...
<!-- Some KeyWords related to topic -->
	<div class="course">
		...
		<div class="det"><a href="computer_courses.blade.php#algo">Algorithm</a></div>
		<div class="det"><a href="computer_courses.blade.php#data">Data Structures</a></div>
		</div>
		<div class="cbox">
	...
	<center>
		<div class="ccardbox">
			...
			<div class="dcard">
				...
				<a href="computer_courses.blade.php#data"><div class="spart">6 Courses <img src="../images/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
