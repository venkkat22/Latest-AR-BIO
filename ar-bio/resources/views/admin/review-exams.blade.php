  ...
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
              @if($attempt->status == 0)
              <a href="#" class="reviewExam" data-id="{{  $attempt->id }}" data-toggle="modal" data-target="#reviewExamModel">Review & Approved</a>
        ...
        @else
        <tr>
            <td colspan="5">Students Have Not Done Any Exams!</td>
        </tr>
        @endif
          ...
          success:function(data){
            ...
            if(data.success == true){
              ...
              if(data.length > 0){
                ...
                html += `<h6>Student have not tried any questions!</h6>
