<head>
	...
	<title>Form 5 Biology Chapters</title>
...
<body>
	...
	{{-- <video src="{{ asset('assets/images/courses/bg-vid.mp4')}}" autoplay loop muted></video> --}}

	<div class="title">
		<span>Form 5 Biology Chapters</span>
		<div class="shortdesc">
			<p>Learn in a fun way with our website!<br></p>
		</div>
	</div>
	<style>
		.new-row {
...
<!-- Quick Links -->
	<div class="course">
		<div class="cbox">
		<div class="det"><a href="{{ asset('subjects/form5') }}" >Chapter 1</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp2') }}">Chapter 2</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp3') }}" >Chapter 3</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp4') }}" >Chapter 4</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp5') }}" >Chapter 5</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp6') }}" >Chapter 6</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp7') }}" >Chapter 7</a></div>
		<div class="new-row"></div> <!-- Add a new row here -->

		<div class="det"><a href="{{ asset('subjects/form5chp8') }}" >Chapter 8</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp9') }}" >Chapter 9</a></div>

		<div class="det"><a href="{{ asset('subjects/form5chp10') }}" >Chapter 10</a></div>

		<div class="det"><a href="{{ asset('subjects/form5chp11') }}" >Chapter 11</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp12') }}" >Chapter 12</a></div>
		<div class="det"><a href="{{ asset('subjects/form5chp13') }}" >Chapter 13</a></div>
